...
(36, 'elo38vr84th171fd00uh52as3h', 17, 'Dell Laptop ', 'pic8.jpg', 1, 20000);
...
(17, 'Dell Laptop ', 20000, 1, 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elPellentesque vehicula augue eget nisl ullamcorper, molestie blandit ipsum auctor. Mauris volutpat augue dolor.Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut lab ore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco. labore et dolore magna aliqua.', 'pic3.jpg', 3, 'Featured');
...
--
ALTER TABLE `compare`
  MODIFY `Compare_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
